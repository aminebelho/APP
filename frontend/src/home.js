 ...
 <div class="row">
      ...
      <div class="col-9">
        <div class="form-box">
          ...
          <h1 class="text-center pb-4">Prévision</h1>
        ...
        <div class="mb-3 row">
           <label class="col-sm-2 col-form-label">Intitulé de l'action</label>
           <div class="col-sm-10">
           <input type="text" class="form-control mb-3" placeholder="" aria-label=""/>
        ...
        <div class="mb-3 row">
           <label class="col-sm-2 col-form-label">Organisme</label>
           <div class="col-sm-10">
            <select class="form-select form-select-lg mb-3" aria-label=".form-select-lg example">
            <option selected></option>
            <option value="1">One</option>
        ...
        <div class="mb-3 row">
           <label class="col-sm-2 col-form-label">Heure/jour</label>
           <div class="col-sm-10">
            <select class="form-select form-select-lg mb-3" aria-label=".form-select-lg example">
            <option selected></option>
            <option value="1">One</option>
